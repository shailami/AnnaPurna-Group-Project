package com.cg.annapurna.OrderServiceWebsite.resource;
...
public class ResourceController {
	...
	public String getAllOrders(Model model) {
		ResponseEntity<List> list = restTemplate.getForEntity("http://localhost:9090/orders", List.class);
	...
	public String placeOrder(@ModelAttribute Address address, Model model) {
		...
		String modeOfPayment = "COD"; // for now
		Double totalAmount = 100.0; // for now
		String restaurantName = "GrandMama's Cafe"; // for now
		Integer id = getUniqueId();
		Order order = new Order(id, modeOfPayment, "pending", orderProducts, totalAmount, 123, restaurantName, address,
				543);
